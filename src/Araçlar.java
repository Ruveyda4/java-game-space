...
public class Araçlar {
	...
	public Araçlar()
	{
		breakBrickImage=new ImageIcon("break_brick.jpg");//vurulması gereken taşlar
		solidBrickImage=new ImageIcon("solid_brick.jpg");//vurulamayan taşlar
		
		for(int i=0; i< brickON.length;i++)//taşların konumları
		{
			brickON[i] = 1;
		}
	}
